...
if (intent) {
  return {
    ...
    tools: getToolsByIntent(intent).slice(0, 24)
  };
}

const readableKeyword = keyword?.replace(/-/g, " ") || "AI";

return {
  title: `Best ${readableKeyword} AI Tools (2026)`,
  description: `Discover the best ${readableKeyword} AI tools in 2026. Compare top-rated AI tools, features, pricing, and use cases in one place.`,
  tools: AI_TOOLS.slice(0, 24)
};
```

}, [keyword]);

const canonicalURL = `https://aitoolshub.com/best/${keyword}`;
